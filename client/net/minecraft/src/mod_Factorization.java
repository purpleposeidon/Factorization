...
import factorization.src.TileEntitySlagFurnace;
import factorization.src.TileEntityWatchDemon;
import factorization.src.TileEntityWrathLamp;
import factorization.src.render.EmptyRender;
import factorization.src.render.EntityWrathFlameFX;
import factorization.src.render.FactorizationRender;
import factorization.src.render.GuiCutter;
import factorization.src.render.GuiMaker;
import factorization.src.render.GuiMechaConfig;
import factorization.src.render.GuiPocketTable;
import factorization.src.render.GuiRouter;
import factorization.src.render.GuiSlag;
import factorization.src.render.GuiStamper;
import factorization.src.render.MechaArmorTextured;
import factorization.src.render.TileEntityBarrelRenderer;
import factorization.src.render.TileEntityWatchDemonRenderer;
...
public class mod_Factorization extends Core {
	...
	public void load() {
		...
		MinecraftForgeClient.preloadTexture(texture_file_particle);
	...
	public boolean onTickInGame(float tickDelta, Minecraft mc) {
		...
		Profiler.startSection("factorizationgametick");
