...
//		v = Math.pow(Math.sin(r*Math.PI*4.5), 2)*r;
    ...
    private static final boolean debug_servo_orientation = false;
    ...
    public void doRender(Entity ent, double x, double y, double z, float yaw, float partial) {
        ...
        //Minecraft.getMinecraft().thePlayer.addChatMessage(prevOrientation + "-->" + orientation + ": " + ro); Be sure to tag this.
        qt.glRotate();
    ...
    static EntityLiving item_holder = new EntityLiving(null) {
        ...
        public ItemStack getHeldItem() { return equiped_item; }
    };
    ...
    void renderEquipment(ServoMotor motor, float partial) {
        equiped_item = motor.getInv().peek();
