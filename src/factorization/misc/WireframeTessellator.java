...
public class WireframeTessellator extends Tessellator
{
    ...
    public static WireframeTessellator instance = new WireframeTessellator(2097152);
    ...
    private WireframeTessellator(int par1)
    {
    }
    
    public WireframeTessellator()
    {
    }
    ...
    public void addVertex(double x, double y, double z) {
        ...
        if (vert == 0) {
            ...
            _addVertex(x, y, z);
            if (vert == 3) {
                _addVertex(startX, startY, startZ);
            }
        }
    }
    /**
     ...
     * full.
     */
    public void _addVertex(double par1, double par3, double par5)
    {
        ...
        if (this.hasBrightness)
        {
            ...
            this.rawBuffer[this.rawBufferIndex + 7] = b;
        }
