...
public class GradleStart
{
    ...
    void parseArgs(String[] args)
    {
        ...
        //values.put("assetsDir",      "/home/poseidon/.gradle/caches/minecraft/assets");
        values.put("assetsDir",      "/home/poseidon/.minecraft/assets/");
    ...
    private void setupAssets()
    {
        ...
        try
        {
            ...
            {
                String key = e.getKey();
                String hash = e.getValue().hash.toLowerCase(Locale.ROOT);
    ...
    private void gatherDir(Map<String, String> map, File base, File target)
    {
        ...
        for (File f : target.listFiles())
        {
            ...
            else
            {
                ...
                String checksum = getDigest(f).toLowerCase(Locale.ROOT);
